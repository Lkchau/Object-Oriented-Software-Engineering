...
public class Dealer extends Player{
    ...
    private String name;
    protected boolean naturalHand = false;
    protected int numToStopAt;
    ...
    public Dealer(Money money, Hand hand, String name){
    ...
    public void setNumToStopAt(int numToStopAt) {
        this.numToStopAt = numToStopAt;
    }

    public int getNumToStopAt() {
        return numToStopAt;
    }
    ...
    public boolean isAbleToPlay(){
        return currentHand.getHandValue() < 17;
    }
    ...
    public boolean equals(Object o) {
        ...
        return CPU == dealer.CPU &&
                naturalHand == dealer.naturalHand &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(CPU, money, currentHand, hiddenCard, initialMoney, name, naturalHand);
    }
