...
public class TriantaEnaDealer extends Dealer{
    ...
    // no-args constructor
    public TriantaEnaDealer(){
        super();
        setNumToStopAt(27);
    }

    // constructor for a dealer
    public TriantaEnaDealer(Money money, Hand hand, String name){
    ...
    public TriantaEnaDealer(boolean CPU){
        this();
        if(CPU){
            createCPU();
        }
    ...
    public boolean equals(Object o) {
        ...
        TriantaEnaDealer dealer = (TriantaEnaDealer) o;
